...
import cn.itrip.trade.service.order.OrderService;
...
public class WxPaymentController {
    ...
    public Dto createCode(@PathVariable String orderNo) {
        try {
            ...
            //异步通知的URL地址。
            data.put("notify_url", "http://itipldh.free.idcfengye.com/trade/api/wx/notify");
    ...
    /**
     * 定义接收来自微信平台的异步通知的方法
     * http://itipldh.free.idcfengye.com/trade/api/wx/notify
