package cn.itrip.search.service.ServiceImpl;
...
import cn.itrip.search.BaseUtil.BaseUtil;
...
public class SearchHotelServiceImpl implements SearchHotelService {
    ...
    private BaseUtil<ItripHotelVO> itripHotelVOBaseQuery = new BaseUtil(URL);
